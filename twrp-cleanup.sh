...
#                                                                                           #
#    This script can/will result in data loss if used on an uncompressed backup or in a     #
#    directory that has already been cleaned. Be sure you have a second copy of any         #
#    backups you intend to clean.                                                           #
#                                                                                           #
